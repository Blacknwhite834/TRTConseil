 ...
 */
final class Version20220823152836 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonce ADD CONSTRAINT FK_F65593E5B6121583 FOREIGN KEY (candidature_id) REFERENCES candidature (id)');

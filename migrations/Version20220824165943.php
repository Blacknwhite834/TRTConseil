 ...
 */
final class Version20220824165943 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D64996D58E56 FOREIGN KEY (info_recruteur_id) REFERENCES profile_recruteur (id)');
